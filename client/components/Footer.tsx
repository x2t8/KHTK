      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Nâng cao năng lực công dân về an toàn số, phòng chống lừa đảo online.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="https://congan.com.vn/tin-tuc-su-kien/canh-bao-cac-hinh-thuc-lua-dao-qua-mang_83525.html" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-blue-400 transition-colors">Cảnh báo lừa đảo</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
            <p>&copy; 2024 Website Tuyên Truyền Chống Lừa Đảo. Được phát triển cho cuộc thi khoa học kỹ thuật giáo dục.</p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <a href="#" className="hover:text-blue-400 transition-colors">Hỗ trợ</a>
            </div>
          </div>
        </div>
      </div>
