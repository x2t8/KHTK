import { ArrowLeft, Monitor, Smartphone, Cloud, Users, Globe, Keyboard, Mouse, Wifi, Lock, Search, Mail, Calendar, FileText, Video, MessageSquare } from "lucide-react";
  ...
  const skillCategories = [
    {
      ...
      skills: [
        {
          name: "Hệ điều hành",
          details: ["Windows/macOS/Linux basics", "File management", "System settings", "Software installation"]
        },
        {
          name: "Microsoft Office/Google Workspace",
          details: ["Word/Docs processing", "Excel/Sheets calculations", "PowerPoint/Slides presentations", "Basic formulas & formatting"]
        },
        {
          name: "Internet Browser",
          details: ["Efficient web navigation", "Bookmarks management", "Privacy settings", "Extensions usage"]
        },
        {
          name: "File Management",
          details: ["Organize folders effectively", "File compression/extraction", "Cloud storage sync", "Backup strategies"]
        }
      ]
    },
    {
      ...
      skills: [
        {
          ...
          details: ["Google search operators", "Academic databases", "Boolean search", "Reverse image search"]
        },
        {
          name: "Đánh giá nguồn tin",
          details: ["Source credibility check", "Fact-checking techniques", "Bias identification", "Cross-referencing"]
        },
        {
          name: "Research methods",
          details: ["Primary vs secondary sources", "Citation practices", "Information synthesis", "Data interpretation"]
        },
        {
          name: "Digital note-taking",
          details: ["Note apps (Notion, Obsidian)", "Tagging systems", "Link connections", "Knowledge management"]
        }
      ]
    },
    {
      ...
      skills: [
        {
          ...
          details: ["Zoom/Teams/Meet mastery", "Screen sharing", "Virtual backgrounds", "Meeting etiquette"]
        },
        {
          name: "Project Management",
          details: ["Trello/Asana/Monday.com", "Task delegation", "Timeline planning", "Progress tracking"]
        },
        {
          name: "Real-time Collaboration",
          details: ["Google Docs editing", "Slack/Discord communication", "Version control basics", "Conflict resolution"]
        },
        {
          name: "Digital Presentations",
          details: ["Interactive presentations", "Live polling", "Q&A management", "Recording & sharing"]
        }
      ]
    },
    {
      ...
      skills: [
        {
          ...
          details: ["Strong password creation", "Password managers", "Two-factor authentication", "Security questions"]
        },
        {
          name: "Privacy Settings",
          details: ["Social media privacy", "Browser privacy", "App permissions", "Data sharing controls"]
        },
        {
          name: "Safe Browsing",
          details: ["Phishing recognition", "Safe download practices", "VPN usage", "Secure connections (HTTPS)"]
        },
        {
          name: "Data Backup",
          details: ["Regular backup schedules", "Cloud vs local storage", "Recovery procedures", "Data encryption"]
        }
      ]
    }
  ];
  ...
  const collaborationTools = [
    {
      ...
      tools: [
        ...
        { name: "Discord", purpose: "Community chat", level: "Gaming/Communities" },
        { name: "Microsoft Teams", purpose: "Enterprise communication", level: "Business" },
        { name: "Zalo/Telegram", purpose: "Personal messaging", level: "Daily use" }
      ]
    },
    {
      ...
      tools: [
        ...
        { name: "Microsoft Teams", purpose: "Enterprise meetings", level: "Business" },
    ...
    },
    {
      ...
      icon: Cloud,
      tools: [
        { name: "Google Drive", purpose: "Cloud storage & docs", level: "Collaboration" },
  ...
  const digitalLiteracyLevels = [
    {
      ...
      skills: ["Gửi email đơn giản", "Tìm kiếm Google", "Sử dụng Facebook", "Xem video YouTube"],
    ...
    },
    {
      ...
      skills: ["Tạo tài liệu Word", "Excel cơ bản", "Video call", "Mua sắm online"],
    ...
    },
    {
      ...
      skills: ["Project management", "Digital marketing", "Data analysis", "Automation"],
    ...
    },
    {
      ...
      skills: ["Digital strategy", "AI implementation", "Tech leadership", "Innovation"],
  ...
  const practicalExercises = [
    {
      ...
      description: "Viết email chuyên nghiệp với subject line rõ ràng, nội dung súc tích",
      time: "15 phút",
      difficulty: "Cơ bản"
    },
    {
      title: "Tạo presentation tương tác",
      description: "Sử dụng Canva/PowerPoint tạo slide có animation và interactive elements",
      time: "45 phút",
      difficulty: "Trung bình"
    },
    {
      title: "Setup workspace hiệu quả",
      description: "Tổ chức desktop, bookmarks, và shortcuts để làm việc nhanh hơn",
      time: "30 phút",
      difficulty: "Cơ bản"
    },
    {
      title: "Collaborative project",
      description: "Làm việc nhóm online với Google Docs và Trello trong 1 tuần",
      time: "1 tuần",
      difficulty: "Nâng cao"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
              ...
              <CardHeader>
                <div className="relative w-20 h-20 mx-auto mb-4">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-lg font-bold text-green-600">{level.percentage}</span>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {category.skills.map((skill, idx) => (
                      <div key={idx} className="bg-white p-4 rounded-lg border">
                        <h4 className="font-semibold text-lg mb-3 text-gray-800">{skill.name}</h4>
                        <ul className="space-y-2">
                          {skill.details.map((detail, detailIdx) => (
                            <li key={detailIdx} className="flex items-start space-x-2">
                ...
                <div className="space-y-4">
                  {toolCategory.tools.map((tool, idx) => (
                    <div key={idx} className="border-l-4 border-blue-200 pl-4">
                      ...
                      <Badge variant="outline" className="text-xs mt-1">{tool.level}</Badge>
                    </div>
                  ))}
                </div>
              </CardContent>
                ...
                <CardHeader>
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Badge className={
                        exercise.difficulty === 'Cơ bản' ? 'bg-green-100 text-green-800' :
                          exercise.difficulty === 'Trung bình' ? 'bg-yellow-100 text-yellow-800' :
      ...
      <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 py-16">
        ...
        <p className="text-xl text-gray-600 mb-8">
          Kỹ năng số không chỉ là xu hướng - đó là yêu cầu thiết yếu của tương lai
        </p>
