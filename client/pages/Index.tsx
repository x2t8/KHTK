...
export default function Index() {
  ...
  const digitalModules = [
    ...
    {
      icon: Bot,
      title: "AI An Toàn", // Sửa lại từ "AI An To��n"
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-50 to-cyan-100">
        ...
        >
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p
              className="text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8 max-w-3xl mx-auto leading-relaxed animate-fade-in"
